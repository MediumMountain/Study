...
termios 関数は、一般的な端末インターフェイスを記述します。
非同期通信ポートを制御するために提供されます。
...
```
struct termios {
    tcflag_t c_iflag;       /* input mode flags */  /* 入力モード */
    tcflag_t c_oflag;       /* output mode flags */ /* 出力モード */
    tcflag_t c_cflag;       /* control mode flags */    /* 制御モード */
    tcflag_t c_lflag;       /* local mode flags */  /* ローカルモード */
    cc_t c_line;            /* line discipline */
    cc_t c_cc[NCCS];        /* control characters */   /* 特殊文字 */
};
